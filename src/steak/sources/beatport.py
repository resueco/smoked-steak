...
from steak.common import handle_scrape_errors
from steak.config import get_user_cfg_path
from steak.errors import ScrapeError
from steak.sources.base import BaseScraper
...
class BeatportBase(BaseScraper):
    ...
    async def initial_setup(self) -> TokenStorage | None:
        ...
        click.secho("Done! Steak will remember this login.", fg="green")
        return token_storage
