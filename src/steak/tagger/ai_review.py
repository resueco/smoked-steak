...
SYSTEM_PROMPT = """You research one exact music release for Smoked Steak.
...
The prompt may include local Steak metadata snapshots; treat them as search hints, not authoritative evidence.
