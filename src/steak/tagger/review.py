...
from steak.constants import RELEASE_TYPES
from steak.errors import InvalidMetadataError
from steak.tagger.metadata import _print_metadata
...
def _warn_classical_genre(metadata: dict) -> None:
    ...
    steak cannot currently enforce automatically. This function alerts the
...
Steak is NOT currently suited for uploading classical music.
...
that steak cannot handle automatically.
