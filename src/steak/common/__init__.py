...
from steak.common.aliases import AliasedCommands
from steak.common.constants import RE_FEAT
from steak.common.files import (
    compress,
    create_relative_path,
    get_audio_files,
)
from steak.common.regexes import (
    parse_copyright,
    re_split,
    re_strip,
)
from steak.common.strings import (
    fetch_genre,
    less_uppers,
    make_searchstrs,
    normalize_accents,
...
async def commandgroup() -> None:
    """Main command group for steak CLI."""
    pass
