...
from steak.tagger.pre_data import construct_track_artists
from steak.tagger.retagger import create_artist_str, create_composer_str, create_track_changes
from steak.tagger.tags import check_required_tags
...
def test_construct_artists_li_preserves_first_seen_role_order() -> None:
    ...
    from steak.tagger.pre_data import construct_artists_li
